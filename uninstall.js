...
const binp = path.join(cargoDir, "bin", "cfn-exports-fetcher");

if (fs.existsSync(binp)) {
  console.log("Uninstalling cfn-exports-fetcher...");
  exec(`cargo uninstall cfn-exports-fetcher`, (error, stdout, stderr) => {
    console.log(stdout);
    if (error || stderr) {
  ...
  console.log("cfn-exports-fetcher not found skipping!");
}
